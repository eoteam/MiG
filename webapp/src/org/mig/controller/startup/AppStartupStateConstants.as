...
package org.mig.controller.startup
{
	...
	public class AppStartupStateConstants
	{
		...
		/***********************************************SETTINGS*************************************************/
		public static const LOADING_SETTINGS:String          			= "state/starting/settings";
		public static const LOAD_SETTINGS:String             			= "event/start/settings";
		public static const LOAD_SETTINGS_COMPLETE:String				= "action/start/settings/complete";
		public static const LOAD_SETTINGS_FAILED:String   				= "action/start/settings/failed";
		/***********************************************SETTINGS*************************************************/
		
		
		
		/***********************************************MANAGERS*************************************************/
		public static const LOADING_MANAGERS:String          			= "state/starting/managers";
		public static const LOAD_MANAGERS:String             			= "event/start/managers";
		public static const LOAD_MANAGERS_COMPLETE:String				= "action/start/managers/complete";
		public static const LOAD_MANAGERS_FAILED:String   				= "action/start/managers/failed";
		/***********************************************MANAGERS*************************************************/		
		...
		public static const LOADING_CONTENTTABS:String					= "state/starting/contenttabs";
		public static const LOAD_CONTENTTABS:String						= "event/start/contenttabs";
		public static const LOAD_CONTENTTABS_COMPLETE:String  			= "action/start/contenttabs/complete";
		public static const LOAD_CONTENTTABS_FAILED:String    			= "action/start/contenttabs/failed";	
		...
		public static const FSM:XML = 
			<fsm initial={STARTING}>
			    ...
			    <!-- THE INITIAL STATE -->
				<state name={STARTING}>
			       <transition action={STARTED} target={LOADING_SETTINGS}/>
			       <transition action={START_FAILED} target={FAILING}/>
				</state>
				
				<!-- CONFIG -->
				<state name={LOADING_SETTINGS} changed={LOAD_SETTINGS}>
				   <transition action={LOAD_SETTINGS_COMPLETE} target={LOADING_MANAGERS}/>			       
				   <transition action={LOAD_SETTINGS_FAILED} target={FAILING}/>
				</state>
		
		
				<!-- CONTENT -->
				<state name={LOADING_MANAGERS} changed={LOAD_MANAGERS}>
				   <transition action={LOAD_MANAGERS_COMPLETE} target={LOADING_TEMPLATES_CFS}/>			       
				   <transition action={LOAD_MANAGERS_FAILED} target={FAILING}/>
				</state>

				<state name={LOADING_TEMPLATES_CFS} changed={LOAD_TEMPLATES_CFS}>
				   <transition action={LOAD_TEMPLATES_CFS_COMPLETE} target={LOADING_CONTENTTABS}/>			       
				   <transition action={LOAD_TEMPLATES_CFS_FAILED} target={FAILING}/>
				</state>
		
				<state name={LOADING_CONTENTTABS} changed={LOAD_CONTENTTABS}>
				   <transition action={LOAD_CONTENTTABS_COMPLETE} target={LOADING_TEMPLATES}/>			       
				   <transition action={LOAD_CONTENTTABS_FAILED} target={FAILING}/>
				</state>		
		
				<state name={LOADING_TEMPLATES} changed={LOAD_TEMPLATES}>
				   <transition action={LOAD_TEMPLATES_COMPLETE} target={LOADING_CONTENT}/>			       
