...
$arrVerbosity[3] = array("content.id","content.title","content.templateid","content.date",
"content_mediaids.mediaids","content_thumbids.thumbids","GROUP_CONCAT(DISTINCT media.path,media.name) AS thumbtitle");


$arrVerbosity[4] = array("content.id","content.title","content.templateid","content.date","content.description","content.url",
"content_mediaids.mediaids","content_thumbids.thumbids","GROUP_CONCAT(DISTINCT media.path,media.name) AS thumbtitle","content2.contentids AS related_content2");
...
$mediaVerbosity[0] = array("media.*", "mimetypes.name as mimetype","content_media.displayorder","content_media.caption","content_media.credits", 
			...
			"GROUP_CONCAT(DISTINCT content.title) AS contenttitles");

$mediaVerbosity[1] = array("media.id","media.name","media.path","media.playtime","mimetypes.name as mimetype","media.url",
						"content_media.caption","content_media.credits","content_media.displayorder");			
